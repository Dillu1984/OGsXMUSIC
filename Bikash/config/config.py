...
START_IMG_URL = getenv("START_IMG_URL", "https://graph.org/file/0eab6ba8b0302de6507fc.jpg")
PING_IMG_URL = getenv("PING_IMG_URL", "https://graph.org/file/29233ece098d8c01888c3.jpg")

PLAYLIST_IMG_URL = "https://graph.org/file/55e7bf0d7f270d94cc787.jpg"
...
if PING_IMG_URL:
    if PING_IMG_URL != "resources/Ping.jpeg":
        if not re.match("(?:http|https)://", PING_IMG_URL):
            PING_IMG_URL = "https://graph.org/file/29233ece098d8c01888c3.jpg"

if START_IMG_URL:
    if START_IMG_URL != "resources/Ping.jpeg":
        if not re.match("(?:http|https)://", START_IMG_URL):
            START_IMG_URL = "https://graph.org/file/0eab6ba8b0302de6507fc.jpg"
